--CREATE TABLE books_table(name TEXT,img TEXT,summary TEXT)

INSERT INTO books_table (name,img,summary)
VALUES 
    ("Harry Potter and the Order of the Phoenix","https://bit.ly/2IcnSwz","Harry Potter and Dumbledore's warning about the return of
    ...
    ("The Lord of the Rings: The Fellowship of the Ring","https://bit.ly/2tC1Lcg","A young hobbit, Frodo, who has found the One Ring that
    ...
    ("Avengers: Endgame","https://bit.ly/2Pzczlb","Adrift in space with no food or water, Tony Stark sends a
